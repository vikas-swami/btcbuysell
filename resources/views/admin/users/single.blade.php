    ...
    <div class="row">
        ...
        <div class="col-md-9">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="widget-small warning coloured-icon">
                            ...
                            <div class="info">
                                ...
                                <p><b>{{round($data->balance,8)}} {{$data->gateway->currency}}</b></p>
                            </div>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="row">
                ...
                <div class="tile">
                    <h3 class="tile-title">
                        <i class="fa fa-user"></i> Advertises </h3>
            ...
            <div class="modal-body">
                <form role="form" method="POST" action="{{route('user.passchange', $user->id)}}"
                    ...
                    <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                        ...
                        <input id="password" type="password" class="form-control" name="password" placeholder="Passowrd"
                               required>
                    ...
                    <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                        ...
                        <input id="password-confirm" type="password" class="form-control" placeholder="Confirm Passowrd"
